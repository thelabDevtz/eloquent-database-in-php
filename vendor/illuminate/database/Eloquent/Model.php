...
abstract class Model implements Arrayable, ArrayAccess, Jsonable, JsonSerializable, QueueableEntity, UrlRoutable
{
    ...
    /**
     * The list of models models that should not be affected with touch.
     *
     * @var array
     */
    ...
    /**
     * Disables relationship model touching for the given model models during given callback scope.
     *
     * @param  array  $models
     * @param  callable  $callback
     * @return void
